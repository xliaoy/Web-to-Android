package com.zx.development.template.security;
...
public class SecurityConfig {
    public static final Set<String> CLASS_WHITELIST = new HashSet<>(Arrays.asList(
            "com.zx.development.template.modules.ToastModule",
            "com.zx.development.template.modules.CameraModule",
            "com.zx.development.template.modules.LocationModule",
            "com.zx.development.template.modules.StorageModule",
            "com.zx.development.template.modules.NetworkModule",
            "com.zx.development.template.modules.VibrationModule",
            "com.zx.development.template.modules.ClipboardModule",
            "com.zx.development.template.modules.SensorModule",
            "com.zx.development.template.FileAccessModule",
            "com.zx.development.template.PermissionManager",
