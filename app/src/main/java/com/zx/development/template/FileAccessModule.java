...
import com.zx.development.template.security.AuditLogger;
...
public class FileAccessModule {
    ...
    public String getStorageRoots() {
        try {
            ...
            sandbox.put("path", "/data/data/com.zx.development.template/files");
    ...
    private File resolvePath(String path) {
        ...
        try {
            ...
            if (canonicalPath.startsWith(root + "/Android/data/com.zx.development.template")) {
                return new File(canonicalPath);
            }
